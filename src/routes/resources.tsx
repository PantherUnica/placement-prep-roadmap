...
const categories = ["All", "AI", "PM", "Analytics", "Interview", "Productivity"] as const;
...
function Page() {
  ...
  const filtered = useMemo(() => {
    return library.filter((r) => {
      ...
      if (q && !r.title.toLowerCase().includes(q.toLowerCase()) && !r.why.toLowerCase().includes(q.toLowerCase())) return false;
      return true;
    });
  }, [q, cat]);
